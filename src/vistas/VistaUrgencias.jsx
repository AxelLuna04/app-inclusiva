...
import { DATOS_URGENCIAS, CATEGORIAS_PRINCIPALES, ICONOS_UI } from '../data/datosApp';

export default function VistaUrgencias({ alVolver, alAgregar }) {
  
  const infoCategoria = CATEGORIAS_PRINCIPALES.find(cat => cat.id === 'urgencias');
